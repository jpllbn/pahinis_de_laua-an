...
<body class="font-sans">
  ...
  <header class="relative bg-cover bg-center text-white h-[70vh] flex items-center justify-center" style="background-image: url('/pahinis_de_laua-an/images/home_background.jpg');">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center w-full text-center px-4">
      <h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-4 tracking-tight text-white drop-shadow-lg font-serif">Pahinis Festival 2026</h1>
  ...
  <section id="festival" class="bg-[#FFF9E6] py-20">
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
      <div class="md:w-1/2 mb-8 md:mb-0">
        <h2 class="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-gray-900 font-serif">The Sweetest Celebration in Western Visayas</h2>
  ...
  <section class="bg-white py-20">
    <div class="container mx-auto px-4 text-center">
      <h2 class="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-gray-900 font-serif">Festival Highlights</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-[#FFF9E6] p-8 rounded-lg shadow-md flex flex-col items-center">
          ...
          <h3 class="text-xl font-bold mb-2 tracking-tight font-serif">Traditional Games</h3>
        ...
        <div class="bg-[#FFF9E6] p-8 rounded-lg shadow-md flex flex-col items-center">
          ...
          <h3 class="text-xl font-bold mb-2 tracking-tight font-serif">Muscovado Production</h3>
        ...
        <div class="bg-[#FFF9E6] p-8 rounded-lg shadow-md flex flex-col items-center">
          ...
          <h3 class="text-xl font-bold mb-2 tracking-tight font-serif">Cultural Performances</h3>
  ...
  <section class="bg-gradient-to-br from-[#7C4A03] to-[#A05A13] text-white py-20">
    <div class="container mx-auto px-4 text-center">
      <h2 class="text-3xl md:text-4xl font-bold mb-4 tracking-tight font-serif">Upcoming Events</h2>
  ...
  <section class="bg-[#FFF9E6] py-20">
    <div class="container mx-auto px-4 text-center">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <img src="/pahinis_de_laua-an/images/festival-gallery/festival-gallery_1.jpg" alt="Gallery Image" class="rounded-lg shadow-md object-cover h-40 w-full">
        <img src="/pahinis_de_laua-an/images/festival-gallery/festival-gallery_2.jpg" alt="Gallery Image" class="rounded-lg shadow-md object-cover h-40 w-full">
        <img src="/pahinis_de_laua-an/images/festival-gallery/festival-gallery_3.jpg" alt="Gallery Image" class="rounded-lg shadow-md object-cover h-40 w-full">
        <img src="/pahinis_de_laua-an/images/festival-gallery/festival-gallery_4.jpg" alt="Gallery Image" class="rounded-lg shadow-md object-cover h-40 w-full">
      </div>
